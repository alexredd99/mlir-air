...
cmake .. \
    ...
    -DARM_SYSROOT=${CMAKE_SYSROOT} \
    -DSysrootAarch64=${CMAKE_SYSROOT} \
    -DARM_SYSROOTSysroot=${CMAKE_SYSROOT} \
    -DLLVM_MINIMUM_PYTHON_VERSION=3.8 \
    -DAIE_RUNTIME_TARGETS=aarch64 \
    -DPython3_INCLUDE_DIR=${CMAKE_SYSROOT}/usr/include/python3.8 \
